...
export const EXPERIENCES = [
  {
    ...
    description: `Worked on navigation and IoT systems for drones, robots, armored vehicles, and aircraft. Developed a unified App using React.js, JavaFX, HTML, and CSS to monitor multiple connected devices. Led dynamic device detection and interface integration for four systems, improving usability and adaptability. Collaborated in a 5-member team and resolved key system bugs.`,
    technologies: ["Javascript", "React.js", "CSS", "JavaFx"],
  },
  // {
  //   year: "2022 - 2023",
...
export const CONTACT = {
  address: "Kolhewadi, Pune-024, Maharashtara ",
  phoneNo: "+91 8446531573 ",
  email: "kolhetushar7955@gmail.com",
};
